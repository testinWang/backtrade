...
class RankZX:
    ...
    # 策略一 有涨停但是持续阴跌的票，放最后
    def yindie(self, code):
        pass

    # 策略二： 涨停后次日放巨量收阴线， 放最后， 巨量：超过涨停日成交量150%
    def huge_yinxian(self, code):
        pass

    # 策略三：连续三日内收阴，且三日没有一日最高涨幅超过3%的 ，放最后
    def three_date_yinxian(self, code):
        pass

    # 策略四：最近有摁地板，
    def dieting(self, code):
        pass

    # 连续三日下跌放巨量
    def xiadie_huge_vol(self,code):
